...
namespace MiniFB
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/newsfeed/index")
                .Include("~/Scripts/newsfeed/main.js"));
            ...
            bundles.Add(new StyleBundle("~/Content/css").Include("~/Content/site.css", "~/Content/newsfeed.css"));
