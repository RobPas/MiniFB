namespace MiniFB.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MiniFB.Models.Contexts.MiniFBContext>
    {
        ...
        protected override void Seed(MiniFB.Models.Contexts.MiniFBContext context) 
        {
            ...
            User User_1 = new User { ID = ID_1, UserName = "goat", Password=pw, Salt=salt, IsAdmin=false, BirthDate = DateTime.Parse("1992-01-01"), FirstName = "Lasse", LastName = "Åberg", Email = "lasse.aberg@hotmail.com", Sex = "Man", IsConfirmed = true };
            User User_2 = new User { ID = ID_2, UserName = "arnold", Password = pw, Salt = salt, IsAdmin = false, BirthDate = DateTime.Parse("1990-05-04"), FirstName = "Arnold", LastName = "Olsson", Email = "arnold@live.se", Sex = "Man", IsConfirmed = true };
            User User_3 = new User { ID = ID_3, UserName = "urban", Password = pw, Salt = salt, IsAdmin = false, BirthDate = DateTime.Parse("1983-01-06"), FirstName = "Urban", LastName = "Explorer", Email = "No email", Sex = "Kvinna", IsConfirmed = true };
