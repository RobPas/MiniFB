...
(function ($, window) {
    ...
    signalR.chatHub = {
        _: {
            hubName: 'chatHub',
            ignoreMembers: ['addChatLine'],
            connection: function () { return signalR.hub; }
        },

        addChatLine: function (username, chatline) {
            return invoke(this, "AddChatLine", $.makeArray(arguments));
        }
    };
    ...
    signalR.moveShape = {
        _: {
            hubName: 'moveShape',
            ignoreMembers: ['moveShape'],
            connection: function () { return signalR.hub; }
        },

        moveShape: function (x, y) {
            return invoke(this, "MoveShape", $.makeArray(arguments));
        }
    };
